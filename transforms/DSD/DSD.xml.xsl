...
<!--
	...
	<structure:KeyFamily id="KF_HW_POST_FAC" agencyID="ZW_MOHCW" version="1.0" isFinal="false">
	  ...
	  <structure:Components>
	    ...
	    <structure:Dimension crossSectionalAttachObservation="true" crossSectionalAttachGroup="true" conceptRef="FACILITY" conceptSchemeRef="CS_DIMENSION" conceptVersion="1.0" conceptSchemeAgency="ZW_MOHCW" codelist="CL_FACILITY" codelistVersion="1.0" codelistAgency="ZW_MOHCW"/>
